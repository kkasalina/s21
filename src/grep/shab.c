...
{
  int ch;
  int eflag = 0, iflag = 0, vflag = 0, cflag = 0, lflag = 0, nflag = 0, hflag = 0, sflag = 0, oflag = 0, fflag = 0;

  static struct option long_options[] =
    {
        {"number-nonblank", 0, 0, 'e'},
        {"number", 0, 0, 'i'},
        {"squeeze-blank" , 0, 0, 'h'}
        
    };

  while ((ch = getopt_long(argc, argv, "+eivclnhsfo", long_options, NULL)) != -1) 
  {
    switch (ch) {
    case 'e':
      eflag = 1;
